...
const Login = () => {
    ...
    return (
        <Flex className='login' flexDirection='column' mb='8'>
            <Heading as="h1" size="2xl" textAlign='center' mb='8' fontFamily='DM Sans' fontWeight='600' letterSpacing='-2px'>SCIONLab Sample Chat</Heading>
            <Flex className="form" gap='1rem' flexDirection={{ base: "column", md: "row" }}>
                ...
                <Input variant='filled' mr={{ base: "0", md: "4" }} mb={{ base: "4", md: "0" }} disabled type="text" placeholder='Room Name' value={room} onChange={e => setRoom(e.target.value)} />
